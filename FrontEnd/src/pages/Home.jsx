      ...
      <Paper sx={{padding: 3, marginY: 3}}>
        <Box>
          ...
          <Typography ml={2} variant="subtitle1">
            ...
            and review books and even preview them. Additionally, you can see
            your personal library, including all the books you've interacted
            with. If you wish to borrow a book, simply make a request for the
            desired duration. Please note that returning books on time is
            essential to avoid fines. You can also apply for employment
            opportunities within the library and receive notifications regarding
            your applications, book requests, and more. There are plenty of
      ...
      <Paper sx={{padding: 3, marginY: 3}}>
        <Box>
          ...
          <Typography ml={2} variant="subtitle1">
            ...
            the ability to notify users for various reasons, including fine
            reminders. As an employee, you can publish news and enjoy all the
            functionalities available to readers. You are responsible for
            handling book requests and can choose to apply for other job
            positions or resign as needed. Exceptional performance may lead to
            promotion to an admin role through the admin panel. BookBreeze
            offers a comprehensive set of tools to streamline your library
            management tasks.
          </Typography>
        </Box>
      </Paper>
      <Paper sx={{padding: 3, marginY: 3}}>
        <Box>
          ...
          <Typography ml={2} variant="subtitle1">
            ...
            applications and manage job listings, including hiring and firing
            employees. They can also send notifications and publish news
            articles. Admins enjoy the same privileges as employees and readers,
            with the added responsibility of guiding library operations. If
            desired, admins can step down from their role to become general
