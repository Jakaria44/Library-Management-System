import { Badge, BadgeOutlined, CalendarMonth, Email, LocationOn, Person, Phone } from "@mui/icons-material";
import {
    Button,
    Card,
    Dialog,
                ...
                <Card sx={{ padding: { md: "16px" } }} elevation={3}>
                    ...
                    >
                        ...
                        <Grid item xs={12} md={4}>
                            <img src={profile.IMAGE} alt={profile.FIRST_NAME} style={{ width: "100%" }} />
                        </Grid>
                    ...
                    <Dialog
                        ...
                        onClose={handleClose}
                    >
                        <DialogTitle sx={{ margin: "auto", fontSize: "1.6rem" }}>Edit Profile</DialogTitle>
                        <DialogContent>
                            <EditProfile
                                profile={profile}
                        ...
                        <DialogActions>
                            <Button disabled={uploading} variant="text" color="error" onClick={handleClose}>
                                Cancel
                            </Button>
