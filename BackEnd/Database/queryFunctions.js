...
export async function getAllBookSumDB (context) {
  let query =
    'SELECT B.ISBN, B.TITLE, B.IMAGE, B.PUBLISH_YEAR, B.NUMBER_OF_PAGES, B.LANGUAGE, LISTAGG(A.NAME, \', \') AS AUTHORS, NVL(ROUND(AVG(R.RATING), 2), 0) AS RATING, P.NAME AS PUBLISHER'
  query +=
